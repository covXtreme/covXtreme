classdef HeffernanTawn
    ...
    methods
        ...
        function HT=ConditionalReturnValue(HT,Mrg,nRls)
            ...
            switch HT.RVMth
                ...
                case 2 %Fixed value from user input
            ...
            for iRtr=1:HT.nRtr %loop over return periods
                ...
                switch HT.RVMth
                    case 1
                        ...
                        RV.f = 1; %MC weights so not needed.
                     case 2
                        ...
                        fGP=Mrg(1).PDF(RV.X(:,1,iRtr),(1:HT.nBin)',I); %transform form uniform to standard margins using CDF
                           
                        RV.F(:,:,iRtr) =exp(-LT.*(1-P));
                        RV.f(:,:,iRtr) = RV.F(:,:,iRtr).*LT.*fGP; %MC weights from return value distirubtion.
                end
    ...
    methods% (Access = private)
        ...
        function p0=startingSolution(HT,X,Y,A,b0)
           ...
           if nargin<=4
            ...
            if HT.NonStat(4)
                ...
                v0=sqrt(ones(HT.nPrm(4),1).*var(R));
            end
        ...
        function [G,H]=Gradient(HT,iP,X,Y,A,p,L)
            ...
            tDel=HT.Delta;
            epsilon=0.5;%1e-1; %deal with delta==1 issues
            %
